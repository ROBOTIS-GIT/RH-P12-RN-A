...
int main(int argc, char **argv)
{
  ...
  g_rh_r2_joint_pub = nh.advertise<std_msgs::Float64>("/rh_p12_rn_a/rh_r2_position/command", 0);
  g_rh_l1_joint_pub = nh.advertise<std_msgs::Float64>("/rh_p12_rn_a/rh_l1_position/command", 0);
  g_rh_l2_joint_pub = nh.advertise<std_msgs::Float64>("/rh_p12_rn_a/rh_l2_position/command", 0);

  ros::Subscriber rh_joint_sub = nh.subscribe("/rh_p12_rn_a/rh_p12_rn_a_position/command", 5, rhJointCallback);
